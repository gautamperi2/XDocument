...
namespace XmlProcessing
{
	...
	public:
		...
		virtual std::vector<std::shared_ptr<AbstractXmlElement>> children() { return std::vector<std::shared_ptr<AbstractXmlElement>>({}); }
		virtual std::vector<std::pair<std::string, std::string>> attributes() { return std::vector<std::pair<std::string, std::string>>({}); }
	...
	{
	public:
		DocElement(std::vector<std::shared_ptr<AbstractXmlElement>> treeFrame, std::shared_ptr<AbstractXmlElement> pRoot = nullptr);
		~DocElement() {}
	...
	std::shared_ptr<AbstractXmlElement> makeDocElement(std::vector<std::shared_ptr<AbstractXmlElement>> treeFrame, std::shared_ptr<AbstractXmlElement> pRoot = nullptr);
